...
@Table(name = "user")
@Entity
public class Usuario extends AuditoryEntity{
    @Id
    ...
    public Usuario(String code, String nombre, String pa_surname, String ma_surname, Date birthdate, String type_doc, String numdoc, String tel, String gra_inst, String nombreUsuario, String email, String password, String tokenPassword, Set<Rol> roles, DocenteEntity docenteEntity, AlumnoEntity alumnoEntity, ApoderadoEntity apoderadoEntity, RolEntity rolEntity, Set<ImagenEntity> imagenEntities, Set<NoticiaEntity> noticiaEntities) {
        this.code = code;
        this.nombre = nombre;
